...
export class eAir extends Homey.Device {
    registers: Object = {
    ...
    processResult(result: Record<string, Measurement>) {
        ...
        if (result['air_supply'] && result['air_supply'].value !== 'xxx') {
            ...
            this.setCapabilityValue('measure_temperature.step', airsupply);
        }
        ...
        if (result['status'] && result['status'].value !== 'xxx') {
            ...
            if (statusValue === '0') { 
                this.setCapabilityValue('eAirstatus', '0');
            } else if (statusValue === '1' ) {
                this.setCapabilityValue('eAirstatus', '1');
            } else if (statusValue === '2') {
                this.setCapabilityValue('eAirstatus', '2');
            } else if (statusValue === '4') {
                this.setCapabilityValue('eAirstatus', '3');
            } else if (statusValue === '7') {
                this.setCapabilityValue('eAirstatus', '4');
            } else if (statusValue === '8') {
                this.setCapabilityValue('eAirstatus', '5');
            }
        }
        ...
        if (result['status_mode'] && result['status_mode'].value !== 'xxx') {
            ...
            if (statusValue === "0") { 
                this.setCapabilityValue('eAirstatus_mode', '0');
            } else if (statusValue === "16") {
                this.setCapabilityValue('eAirstatus_mode', '1');
            } else if (statusValue === "1024") {
                this.setCapabilityValue('eAirstatus_mode', '2');
            } else if (statusValue === "512") {
                this.setCapabilityValue('eAirstatus_mode', '3');
            }
        }  
